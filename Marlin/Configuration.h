...
#define STRING_CONFIG_H_AUTHOR "(jward)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "ANYCUBIC K2"
...
#define DELTA
  ...
  #define DELTA_HEIGHT 323.4 // get this value from auto calibrate
...
#define X_MIN_ENDSTOP_INVERTING true // we have no X_MIN endstop
#define Y_MIN_ENDSTOP_INVERTING true // we have no Y_MIN endstop
...
// These values came from the original Anycubic Kossel Linear firmware
 ...
 *    (0,0)
 */
// Offsets for http://www.thingiverse.com/thing:1976680 version 1
